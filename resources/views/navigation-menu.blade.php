@php
   $nav_links = [
    [
        ...
        'icon' => 'fas fa-home', // Agrega el icono FontAwesome aquí
    ],
    [
        'name' => 'Quienes somos',
        'route' => route('quienessomos.index'),
        'active' => request()->routeIs('quienessomos.index'),
        'icon' => 'fas fa-users', // Icono de usuarios como ejemplo
    ],
    // [
    //     'name' => 'Donaciones',
    //     'route' => route('donaciones.index'),
    //     'active' => request()->routeIs('donaciones.index'),
    //     'icon' => 'fas fa-donate', // Icono de donaciones como ejemplo
    // ],
    [
        'name' => 'Donaciones',
        'route' => route('products.list'),
        'active' => request()->routeIs('products.list'),
        'icon' => 'fas fa-donate', // Icono de donaciones como ejemplo
    ],
                ...
                <div class="hidden space-x-4 sm:-my-px sm:ml-10 sm:flex">
                    @foreach ($nav_links as $nav_link)
                        <x-nav-link href="{{ $nav_link['route'] }}" :active="$nav_link['active']">
                            <i class="{{ $nav_link['icon'] }} mr-2"></i> {{ $nav_link['name'] }}
                        </x-nav-link>
                    @endforeach
